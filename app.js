const insights = [
  ...
  {"id":9,"name":"09.옷장이 아니라 '유니폼' (Not a Wardrobe, But a Uniform)","perspective":"개성이 아닌 보편성, 유행이 아닌 영속성을 제공하는 것이 오히려 더 강력한 선택이 될 수 있다.","law":"1 선택 피로 법칙","keywords":["보편성","선택의 단순화","유니클로","유니폼","일상의 표준"],"track":"Track2:삶의 태도","slides":[{"headline":"스티브 잡스는 평생 검은 터틀넥만 입었습니다","narrative":"세상을 바꾼 천재가 선택한 것은 '개성 있는 옷'이 아니라 '생각할 필요 없는 옷'이었습니다."},{"headline":"마크 저커버그는 회색 티셔츠 20벌을 똑같이 삽니다","narrative":"아침마다 무슨 옷 입을지 고민하는 게 에너지 낭비라고 말했습니다."},{"headline":"대부분의 브랜드는 '당신만의 개성을 표현하세요'라고 말합니다","narrative":"더 다양한 스타일, 더 독특한 디자인, 더 많은 선택지 - 차별화가 곧 가치였습니다."},{"headline":"유니클로는 정반대로 물었습니다: '매일 입어도 질리지 않는 옷은?'","narrative":"개성 대신 보편성을, 유행 대신 영속성을 - 옷장이 아니라 '유니폼'을 만들었습니다."},{"headline":"그 순간, 옷은 '선택의 대상'이 아니라 '당연한 일상'이 됩니다","narrative":"고민 없이 입고, 생각 없이 세탁하고, 망설임 없이 다시 사는 - 옷이 사라지고 삶만 남습니다."},{"headline":"전 세계 사람들이 같은 옷을 입기 시작했습니다","narrative":"뉴욕, 도쿄, 서울, 파리 - 도시는 달라도 모두가 같은 검은 바지를 입고 살아갑니다."},{"headline":"선택을 없애는 것이 진짜 자유입니다","narrative":"매일 고민하게 만들지 마세요 - 생각 없이 쓸 수 있을 때, 비로소 본질에 집중할 수 있습니다."}],"btlType":["경험공간"],"spaceDesign":"The Uniform Lab (유니폼 연구소) — 입구: 선택 과부하 터널(양쪽 벽면에 수백 가지 선택지가 빠르게 지나감) → Zone1: 유니폼의 탄생(잡스/저커버그/오바마 전시) → Zone2: 선택의 역설(인터랙티브 체험, 50가지 vs 1가지 선택 시간 비교) → Zone3: LG의 유니폼(제품 4가지 원버튼 체험) → Zone4: 세계는 하나의 방식으로(실시간 세계 지도 데이터) → Zone5: 해방된 일상(한 가족의 하루 영상) → 출구: 유니폼 선언문","experienceDesign":"핵심 인터랙션: ①입구 터널에서 선택 과부하를 체감시킴 ②Zone2에서 직접 50가지 중 선택 vs 버튼 하나 체험으로 시간 차이 체감(45초 vs 2초) ③Zone3에서 실제 LG 제품 원버튼 작동 ④Zone5에서 조용한 방에서 해방된 일상 영상 감상. 감정 흐름: 압도→깨달음→체험→감동","executionIdea":"LG 올인원 세탁건조기 적용: 'AI 빨래' 버튼 하나로 무게/오염도/직물 자동 감지. 모든 LG 가전에 '유니폼 전략' 확장 가능 - 세탁기, 오븐, 에어컨, 냉장고 모두 원버튼 AI 자동화. 핵심 카피: '우리가 만드는 것은 제품이 아니라 유니폼입니다'","kpi":"체험 전후 선택 시간 비교(45초→2초), 원버튼 체험 후 제품 관심도, 체류시간, SNS 공유율(선택의 역설 인터랙션)"},
